...
class TvShowsFragment : Fragment(R.layout.fragment_list) {
    ...
    private val adapter = TvAdapter { _view, id ->
        val direction = MainFragmentDirections.actionMainFragmentToDetailTvShowFragment(id)
    ...
    private fun loadData() {
        ...
        tvShowsViewModel.isConnected = requireContext().isConnected()
        tvShowsViewModel.getData()
        loadJob?.cancel()
        loadJob = viewLifecycleOwner.lifecycleScope.launch {
            tvShowsViewModel.getTvShows().collectLatest {
